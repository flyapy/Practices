...
namespace Practices.Presentation.Media
{
    public class RgbaColor
    {
        ...
        /// 亮度 0 - 100
        /// </summary>
        public int Y { get { return MediaManager.GetBrightness(R, G, B); } }
        ...
        {
            RgbaColor rgba = MediaManager.HsbaToRgba(new HsbaColor(h, s, b, a));
            R = rgba.R;
            G = rgba.G;
            B = rgba.B;
            A = rgba.A;
        ...
        public HsbaColor HsbaColor { get { return MediaManager.RgbaToHsba(this); } }
    }
}
